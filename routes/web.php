...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/tanda-terima/{id}/invoices', [TandaTerimaController::class, 'getInvoicesDetail'])->name('getTandaInvoices');
    ...
    Route::get('/dashboard/edit/tanda-terima/{id}/{from}', [TandaTerimaController::class, 'showEditForm'])->name('tanda-terima.edit');
    Route::get('/dashboard/print/tanda-terima/{id}', [TandaTerimaController::class, 'printTandaTerima'])->name('tanda-terima.print');
    Route::put('/dashboard/edit/tanda-terima/{id}/{from}', [TandaTerimaController::class, 'update'])->name('tanda-terima.update');
    Route::get('/dashboard/edit/bukti-kas/{id}/{from}', [BuktiKasController::class, 'showEditForm'])->name('bukti-kas.edit');
    Route::put('/dashboard/edit/bukti-kas/{id}/{from}', [BuktiKasController::class, 'update'])->name('bukti-kas-update.edit');
    Route::put('/dashboard/finish/bukti-kas/{id}', [BuktiKasController::class, 'finish'])->name('finish');
    Route::get('/get-supplier-info/{tandaTerimaId}/{buktiKasId?}/{from?}', [BuktiKasController::class, 'getSupplierInfo'])->name('get-supplier-info');
