                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 table">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 {{ $user->status === 'inactive' ? 'text-red-500' : ($user->status === 'active' ? 'text-green-500' : 'text-gray-500') }}">{{ $user->status }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="dropdown-{{ $user->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button-{{ $user->id }}">
                                            ...
                                            <li>
                                                <button type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400" data-delete-id="{{ $user->id }}">
