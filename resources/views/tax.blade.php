                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 table">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">@sortablelink('name','Nama')</th>
                                <th scope="col" class="px-4 py-3">Persentase</th>
                                <th scope="col" class="px-4 py-3">@sortablelink('type','Tipe')</th>
                                <th scope="col" class="px-4 py-3">@sortablelink('status','Status')</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $tax->type }}</td>
                                <td class="px-4 py-3 max-w-[12rem] truncate {{ $tax->status === 'inactive' ? 'text-red-500' : ($tax->status === 'active' ? 'text-green-500' : 'text-gray-500') }}">{{ $tax->status }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="dropdown-button-{{ $tax->id }}" data-dropdown-toggle="dropdown-{{ $tax->id }}" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-{{ $tax->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button-{{ $tax->id }}">
                                            <li>
                                                <button id='edit-button' type="button" data-modal-target="updateProductModal" data-modal-toggle="updateProductModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200" data-tax-id="{{ $tax->id }}" data-tax-name="{{ $tax->name }}" data-tax-percentage="{{ $tax->percentage }}" data-tax-type="{{$tax->type}}" data-tax-status="{{$tax->status}}">
                                            ...
                                            <li>
                                                <button type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400" data-delete-id="{{ $tax->id }}">
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Tax</h3>
                    ...
                    <form action="{{ route('tax.store') }}" method="post">
                        ...
                        <div class="grid gap-4 mb-10 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                <label for="percentage" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Percentage</label>
                                <input type="number" step="0.01" name="percentage" id="percentage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan persentase" required>
                            </div>
                            <div class="col-span-2">
        ...
        <div id="updateProductModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    <!-- Modal header -->
                    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update Tax</h3>
                    ...
                    <form id='edit-form' action="#" method="post">
                        ...
                        <div class="grid mb-10 gap-4 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                <label for="percentage" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Persentase</label>
                                <input type="number" step="0.01" name="percentage" id="editpercentage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan persentase" required>
                            </div>
                            <div class="col-span-2">
                                <label for="type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Type</label>
                                <select id="type" name="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <option id="type-ppn" value="ppn">PPN</option>
                                    <option id="type-pph" value="pph">PPh</option>
                                </select>
                            </div>
                            <div class="col-span-2">
        ...
        <div id="deleteModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this tax?</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('[data-tax-id]').forEach(button => {
            button.addEventListener('click', function() {
                const id = this.getAttribute('data-tax-id');
                const name = this.getAttribute('data-tax-name');
                const percentage = this.getAttribute('data-tax-percentage');
                const type = this.getAttribute('data-tax-type');
                const status = this.getAttribute('data-tax-status');
                console.log(id);
                ...
                if (updateForm) {
                    ...
                    if (typeSelect) {
                        const typeOption = document.getElementById('type-' + type);
                        if (typeOption) {
                    ...
                    if (statusSelect) {
                        const statusOption = document.getElementById('status-' + status);
                        if (statusOption) {
