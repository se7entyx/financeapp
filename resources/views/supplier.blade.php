<x-layout>
    ...
    <section class="w-full bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        ...
        @if ($errors->any())
        <script>
            alert('Data gagal ditambahkan, cek nama suppliernya');
        </script>
        @endif
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex items-center justify-between p-4">
                    ...
                    <form class="w-2/3 max-w-lg mr-4 m-0 p-0">
                        @csrf
                        ...
                        <div class="relative">
                            ...
                            <input name="search" type="search" id="default-search" value="{{ old('search') }}" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Supplier Name" autocomplete="off" />
                    ...
                    <form action="{{ route('supplier.store') }}" method="post">
                        ...
                        <div class="grid gap-4 mb-10 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="text" name="alias" id="alias" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan alias">
                            </div>
                            <div class="col-span-2">
                                <label for="norek" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Rekening</label>
                                <input type="text" name="norek" id="norek" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan Nomor Rekening">
                            </div>
                            <div class="col-span-2">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form id='edit-form' action="#" method="post">
                        ...
                        <div class="grid mb-10 gap-4 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                <label for="alias" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alias</label>
                                <input type="text" name="alias" id="editalias" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan alias">
                            </div>
                            <div class="col-span-2">
                                <label for="norek" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Rekening</label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('[data-supplier-id]').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const alias = this.getAttribute('data-supplier-alias');
                    ...
                    if (updateForm) {
                        updateForm.action = "{{ route('supplier.updateSupplier', ':id') }}".replace(':id', id);
            ...
            document.querySelectorAll('[data-delete-id]').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    if (deleteForm) {
                        deleteForm.action = "{{ route('supplier.destroy', ':id') }}".replace(':id', id);
                    }
                });
            });
        });
