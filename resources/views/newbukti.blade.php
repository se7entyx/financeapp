<x-layout>
      ...
      <form action="#">
        <div class="grid gap-x-8 gap-y-4 mb-6 lg:grid-cols-4 md:grid-cols-1 sm:grid-cols-1">
          ...
          <div class="col-start-1">
            ...
            <input type="text" id="input-bank" value="Mandiri" class=" bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled readonly>
          </div>
          <div class="col-span-1">
            <label for="jumlah-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah USD / Rp</label>
          ...
          <div class="col-start-1">
            <form class="max-w-sm">
              ...
              <div class="relative max-w-sm">
                ...
                <input id="datepicker-autohide" datepicker-format="dd-mm-yyyy" datepicker-autohide type="text" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 cursor-not-allowed focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Automatic input" readonly disabled>
              </div>
            </form>
          </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Set default value
      dropdownButton.innerHTML = 'IDR <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" /></svg>';
      ...
      menuItems.forEach(item => {
        item.addEventListener('click', function() {
          ...
          dropdownButton.innerHTML = `${selectedCurrency} <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" /></svg>`;
